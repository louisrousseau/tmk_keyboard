...
*/
    ...
    PAUS,ESC,   GRV, 1,   2,   3,   4,   5,   6,   7,   8,   9,   0,   MINS,EQL, NO,  BSPC,  INS, HOME,PGUP,  NLCK,PSLS,PAST,PMNS,
    PSCR,SLCK,  TAB, Q,   W,   E,   R,   T,   Y,   U,   I,   O,   P,   LBRC,RBRC,     NO,    DEL, END, PGDN,  P7,  P8,  P9,  PPLS,
    VOLD,VOLU,  CAPS,A,   S,   D,   F,   G,   H,   J,   K,   L,   SCLN,QUOT,     BSLS,ENT,        UP,         P4,  P5,  P6,  NO,
    MPLY,MUTE,  LSFT,NUBS,Z,   X,   C,   V,   B,   N,   M,   COMM,DOT, SLSH,     NO,  RSFT,  LEFT,DOWN,RGHT,  P1,  P2,  P3,  PENT,
    MNXT,LGUI,  LCTL,     LALT,               SPC,                          RALT,     RCTL,        NO,        NO,  P0,  PDOT,NO
    ),
